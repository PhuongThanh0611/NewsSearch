...
class MainActivity : AppCompatActivity() , PresenterToView,DocListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter?.requestSearch(currentPage,sortOrder,beginDate,news,search)
        setEvent()
...
// xử lý item của menu
    ...
    override fun CallApiSuccess(result: Response) {
        docsAdapter.AddList(result.docs)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(resultCode== Activity.RESULT_OK && requestCode==999){
            ...
            if (data != null) {
              ...
              //  Toast.makeText(this,news + "vhgc "+sortOrder+ "hgsjdvf"+beginDate,Toast.LENGTH_LONG).show();
            }
